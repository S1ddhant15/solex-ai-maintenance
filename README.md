...
The active SAMA interface is intentionally limited to a department-controlled AI Chat and Machine Status workspace.
...
The navigation is generated by `js/samaShell.js` and contains only these two options. Legacy Analytics, Operations, PM and other direct routes are redirected to AI Chat by `js/portalGuard.js`.
